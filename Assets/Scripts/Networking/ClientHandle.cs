...
public class ClientHandle : MonoBehaviour
{
    public static void Welcome(Packet _packet)
    {
        ...
        UIManager.instance.DisableConnectMenu();
    }
    ...
    public static void TileHealth(Packet _packet)
    {
        int _tileId = _packet.ReadInt();
        int _health = _packet.ReadInt();

        GameManager.instance.world.GetComponent<GridGenerator>().SetTileHealth(_tileId, _health);
    }

    public static void ResetWorld(Packet _packet)
    {
        //Debug.Log("Client Handle - ResetWorld");
        GameManager.instance.world.GetComponent<GridGenerator>().ResetWorld();
    }
}
